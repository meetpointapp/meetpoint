...
String errorText(AppLocalizations l, Object error) {
  ...
  return switch (error.code) {
    ...
    'kyc_required' => l.errKycRequired,
    'kyc_pending' => l.errKycPending,
    'kyc_already_approved' => l.errKycApproved,
    'invalid_tc' => l.errInvalidTc,
    'tc_in_use' => l.errTcInUse,
    'full_name_required' => l.errFullNameRequired,
    'account_name_mismatch' => l.errAccountNameMismatch,
